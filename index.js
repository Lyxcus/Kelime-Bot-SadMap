...
client.on('ready', () =>{
	client.user.setActivity(`k!yardım || #kelime-oyunu`, { type : 'WATCHING' });
		...
		message.channel.send({ embed :{
			...
			'fields': [
				...
				},
				{
					...
					'value': '``<prefix>`` **Botun Prefixini Temsil Eder İlk Seferde ``k!`` olarak gelir değiştirmek için k!prefix ``<yeniprefix>`` Yazılması Yeterlidir**',
				},
			],
			'author': {
